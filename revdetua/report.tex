...
PLOT COMPLEXIDADES EM FUNCAO DE N
...
\subsection{(3) the number of solutions / configurations tested}
...
\midrule
Nome do algoritmo & $32\%$ & $32\%$ \\
Nome do algoritmo & $32\%$ & $32\%$ \\
SA (t: 1000, cr: 0.99) & $32\%$ & $32\%$ \\
Nome do algoritmo & $32\%$ & $32\%$ \\
Nome do algoritmo & $32\% \ (4.3)$ & $32\% \ (4.3)$ \\
\bottomrule
\end{tabular}
\end{table}
